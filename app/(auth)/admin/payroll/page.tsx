...
export default function Page() {
  return (
    ...
    <div className="text-center mb-4 flex flex-direction-row justify-between">
      ...
      <h1 style={{ color: '#1f3864', fontSize: '50px', fontFamily: {sans: ['Montserrat', 'sans-serif'],}  }} className="text-2xl font-bold"><i>MotorPH</i></h1>
      <br />
      <p className="font-bold" style={{ color: '#1f3864', fontFamily: {sans: ['Montserrat', 'sans-serif'],} }}>7 Jupiter Avenue cor. F. Sandoval Jr., Bagong Nayon, Quezon City</p>
      <p className="font-bold" style={{ color: '#1f3864', fontFamily: {sans: ['Montserrat', 'sans-serif'],} }}>Phone: (028) 911-5071 / (028) 911-5072 / (028) 911-5073</p>
      <p className="font-bold" style={{ color: '#1f3864', fontFamily: {sans: ['Montserrat', 'sans-serif'],} }}>Email: corporate@motorph.com</p>
      </div>
    </div>
    <h2 style={{ color: '#1f3864', fontFamily: {sans: ['Montserrat', 'sans-serif'],} }} className="text-center text-xl font-bold mb-4"><u>EMPLOYEE PAYSLIP</u></h2>
